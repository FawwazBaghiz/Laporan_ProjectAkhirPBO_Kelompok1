...
class MenuMakanan:
    ...
    def __str__(self):
        return f"Menu ID: {self.menuID}, Nama: {self.namaMakanan}, Deskripsi: {self.deskripsi}, Harga: {self.harga}, Ketersediaan: {'Tersedia' if self.ketersediaan else 'Tidak Tersedia'}, ID Restoran: {self.idRestoran}"
